...
public class MysteryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        set(MysteryActivity.this, SplashActivity.class.getName(), "com.example.overseaswhitebag.privacy.MysteryAliasActivity");
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
            ...
            disableComponent(MysteryActivity.this, "com.example.overseaswhitebag.privacy.MysteryAliasActivity");
        }
