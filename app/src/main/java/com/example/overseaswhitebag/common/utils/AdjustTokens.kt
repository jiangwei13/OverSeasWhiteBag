...
object AdjustTokens {
    fun initAdJustToken(context: Context) {
        ...
        when (channel) {
            "GP" ->{
                AjConstants.adjustAppToken = "vfyfd391meio";
                AjConstants.Login = "";
                AjConstants.Reg = "";
                AjConstants.topon_ilrd = "ajfij5";
                AjConstants.ipu = "2hpf5t";
                AjConstants.arpu = "vap2jq";
                AjConstants.ipu_arpu = "cid68j";
                AjConstants.ipu_ecpm = "es1n2d";
                AjConstants.ipu_arpu_ecpm = "2w2uss";
                AjConstants.blacklist = "sopts6";
                AjConstants.ad_request = "6pcrai";
                AjConstants.ad_filled = "z9b1w6";
                AjConstants.firebase_request ="k6faj7";
                AjConstants.firebase_success = "j7aufw";
                AjConstants.adJust_attribution_request = "8hw3lb";
