...
import coyj.gtuc.dzy.ad.AdViewMana;
...
public class XVIV extends AppCompatActivity {
...
//        }
    ...
    private void showProtocolDialog() {
        XVOC protocolDialog = new XVOC(this, R.style.dialog);
        protocolDialog.show();

        logDebugInfo("Protocol dialog displayed");

        protocolDialog.setOnProtocolDialogListener(new XVOC.OnProtocolDialogListener() {
            @Override
            public void agree() {
    ...
    private void toMain() {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                Intent it = new Intent(XVIV.this, XVJL.class);
    ...
    private boolean verifyIntentCompatibility() {
        try {
            Intent testIntent = new Intent(this, XVJL.class);
