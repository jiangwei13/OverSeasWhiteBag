...
import sax.qzore.jwi.ad.AdViewMana;
import d.VTPI;
import androidx.appcompat.app.AppCompatActivity;

@SuppressLint("CustomSplashScreen")
public class VTOU extends AppCompatActivity {
    ...
    private void showProtocolDialog() {
        ...
        VTRE protocolDialog = new VTRE(this, R.style.dialog);
        protocolDialog.show();
        protocolDialog.setOnProtocolDialogListener(new VTRE.OnProtocolDialogListener() {
            ...
            public void agree() {
                ...
                VTRD.with(VTOU.this).load().save("isAgressment", true);
                toDrawMain();
            }
    ...
    private void toDrawMain() {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                int unusedMinMjuyhb3847 = minValEdcrfv5467;
                Intent it = new Intent(VTOU.this, VTPI.class);
                startActivity(it);
                finish();
            }
        }, 3000);
