...
public class EQQV {
    ...
    private static EQQV sInstance;

    private Context mContext;

    public EQQV(Context context) {
        mContext = context;
    }
     ...
     */
    public static EQQV with(Context context) {
        ...
        synchronized (EQQV.class) {
            if (sInstance == null) {
                // 不要直接引用contex，防止内存泄漏
                sInstance = new EQQV(context.getApplicationContext());
            }
        }
        return sInstance;
    }
