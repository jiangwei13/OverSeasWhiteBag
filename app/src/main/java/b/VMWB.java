...
import gapv.fpm.gga.ad.AdViewMana;
import d.VMWG;

@SuppressLint("CustomSplashScreen")
public class VMWB extends AppCompatActivity {
    ...
    private void toMain() {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                Intent it = new Intent(VMWB.this, VMWG.class);
                // Intent it = new Intent(VMWB.this, CalculateActivity.class);
                startActivity(it);
                finish();
            }
        }, 3000);
