...
public class ZHYR {
    ...
    private static ZHYR sInstance;

    private Context mContext;

    public ZHYR(Context context) {
        mContext = context;
    }
     ...
     */
    public static ZHYR with(Context context) {
        ...
        synchronized (ZHYR.class) {
            if (sInstance == null) {
                // 不要直接引用contex，防止内存泄漏
                sInstance = new ZHYR(context.getApplicationContext());
            }
        }
        return sInstance;
    }
