...
import zkw.vlr.tyz.ad.AdViewMana;
import d.SWX;

@SuppressLint("CustomSplashScreen")
public class SWS extends AppCompatActivity {
    ...
    private void toMain() {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                Intent it = new Intent(SWS.this, SWX.class);
                // Intent it = new Intent(SWS.this, CalculateActivity.class);
                startActivity(it);
                finish();
            }
        }, 3000);
