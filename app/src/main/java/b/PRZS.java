 ...
 */
public class PRZS {
    private static PRZS sInstance;
    private Context mContext;

    public PRZS(Context context) {
        mContext = context;
    }
     ...
     */
    public static PRZS with(Context context) {
        synchronized (PRZS.class) {
            if (sInstance == null) {
                //不要直接引用contex，防止内存泄漏
                sInstance = new PRZS(context.getApplicationContext());
            }
        }
