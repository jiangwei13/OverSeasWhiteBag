 ...
 */
public class CIGW {
    private static CIGW sInstance;
    private Context mContext;

    public CIGW(Context context) {
        mContext = context;
    }
     ...
     */
    public static CIGW with(Context context) {
        synchronized (CIGW.class) {
            if (sInstance == null) {
                //不要直接引用contex，防止内存泄漏
                sInstance = new CIGW(context.getApplicationContext());
            }
        }
