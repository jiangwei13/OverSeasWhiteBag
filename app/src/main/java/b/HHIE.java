...
public class HHIE {
    ...
    private static HHIE sInstance;

    private Context mContext;

    public HHIE(Context context) {
        mContext = context;
    }
     ...
     */
    public static HHIE with(Context context) {
        ...
        synchronized (HHIE.class) {
            if (sInstance == null) {
                // 不要直接引用contex，防止内存泄漏
                sInstance = new HHIE(context.getApplicationContext());
            }
        }
        return sInstance;
    }
