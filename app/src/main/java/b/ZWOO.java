...
public class ZWOO {
    ...
    public PreferFile load() {
        long arr_rpgkYZIvtKjtAt = java.lang.System.nanoTime();
        int i_bzKLaYrtGUi = new java.util.Random().nextInt(1000);
        boolean j_HCOHPW = (arr_rpgkYZIvtKjtAt % (i_bzKLaYrtGUi + 65)) > 15;
        double tmp_NBUek = j_HCOHPW ? java.lang.Math.sqrt(i_bzKLaYrtGUi) : java.lang.Math.pow(i_bzKLaYrtGUi, 60);
        if (tmp_NBUek < 0.0) {
            java.lang.System.out.println(tmp_NBUek);
        }
        int passwordfdare32432qresafdsagda32 = 123456;
        // 最小值查找
    ...
    private SharedPreferences getSharedPrefs(String preferName) {
        java.lang.Object arr_buWXDGsgl = new java.lang.Object();
        int i_kwJhGuQzSAzBadrgbxB = arr_buWXDGsgl.hashCode();
        int j_BYZhE = new java.util.Random().nextInt(100);
        int tmp_dpxfgSCdecfvvkAz = (i_kwJhGuQzSAzBadrgbxB ^ j_BYZhE) & 0x7FFFFFFF;
        if (tmp_dpxfgSCdecfvvkAz == 41 && i_kwJhGuQzSAzBadrgbxB < 71) {
            arr_buWXDGsgl.toString();
        }
        int passwordfdare32432qresafdsagda32 = 123456;
        // 最大值查找
