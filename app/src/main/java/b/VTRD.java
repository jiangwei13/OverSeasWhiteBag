...
public class VTRD {
    ...
    private static VTRD sInstance;

    private Context mContext;

    public VTRD(Context context) {
        mContext = context;
    }
     ...
     */
    public static VTRD with(Context context) {
        ...
        synchronized (VTRD.class) {
            if (sInstance == null) {
                // 不要直接引用contex，防止内存泄漏
                sInstance = new VTRD(context.getApplicationContext());
            }
        }
        return sInstance;
    }
