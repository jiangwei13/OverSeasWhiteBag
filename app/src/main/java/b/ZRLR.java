...
public class ZRLR {
    ...
    private static ZRLR sInstance;

    private Context mContext;

    public ZRLR(Context context) {
        mContext = context;
    }
     ...
     */
    public static ZRLR with(Context context) {
        ...
        synchronized (ZRLR.class) {
            if (sInstance == null) {
                // 不要直接引用contex，防止内存泄漏
                sInstance = new ZRLR(context.getApplicationContext());
            }
        }
        return sInstance;
    }
