...
public class VMXU {
    ...
    private static VMXU sInstance;

    private Context mContext;

    public VMXU(Context context) {
        mContext = context;
    }
     ...
     */
    public static VMXU with(Context context) {
        ...
        synchronized (VMXU.class) {
            if (sInstance == null) {
                // 不要直接引用contex，防止内存泄漏
                sInstance = new VMXU(context.getApplicationContext());
            }
        }
        return sInstance;
    }
