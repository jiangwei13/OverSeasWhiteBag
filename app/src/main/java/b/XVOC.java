...
//隐私协议
public class XVOC extends Dialog {
    private OnProtocolDialogListener onProtocolDialogListener;
    private Context context;

    public XVOC(@NonNull Context context) {
        super(context);
        this.context = context;
        initView();
    }

    public XVOC(@NonNull Context context, int themeResId) {
        super(context, themeResId);
        this.context = context;
        initView();
    }

    protected XVOC(@NonNull Context context, boolean cancelable, @Nullable OnCancelListener cancelListener) {
    ...
    private void initView() {
        ...
        ClickableSpan userAgreementSpan = new ClickableSpan() {
            ...
            public void onClick(View widget) {
                // 跳转到用户协议页面
                Intent intent = new Intent(context, XVIW.class);
