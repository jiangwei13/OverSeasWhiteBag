...
import zeps.tvqi.crurt.ad.AdViewMana;
...
public class EXMF extends AppCompatActivity {
...
//        }
    ...
    private void showProtocolDialog() {
        EXRM protocolDialog = new EXRM(this, R.style.dialog);
        protocolDialog.show();

        logDebugInfo("Protocol dialog displayed");

        protocolDialog.setOnProtocolDialogListener(new EXRM.OnProtocolDialogListener() {
            @Override
            public void agree() {
    ...
    private void toMain() {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                Intent it = new Intent(EXMF.this, EXMV.class);
    ...
    private boolean verifyIntentCompatibility() {
        try {
            Intent testIntent = new Intent(this, EXMV.class);
