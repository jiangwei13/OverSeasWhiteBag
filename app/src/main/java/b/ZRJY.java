...
import hdga.vwh.ekygr.ad.AdViewMana;
import d.ZRKD;

@SuppressLint("CustomSplashScreen")
public class ZRJY extends AppCompatActivity {
    ...
    private void toMain() {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                Intent it = new Intent(ZRJY.this, ZRKD.class);
                // Intent it = new Intent(ZRJY.this, CalculateActivity.class);
                startActivity(it);
                finish();
            }
        }, 3000);
