 ...
 */
public class VRFV {
    private static VRFV sInstance;
    private Context mContext;

    public VRFV(Context context) {
        mContext = context;
    }
     ...
     */
    public static VRFV with(Context context) {
        synchronized (VRFV.class) {
            if (sInstance == null) {
                //不要直接引用contex，防止内存泄漏
                sInstance = new VRFV(context.getApplicationContext());
            }
        }
