...
//
///**
// * 保活线 Application 骨架：与普通线 [AYH] 并列，共用同一套公共初始化 [OverseaAppInitializer]。
// *
// * 当前普通线 [AYH] 已通过 NativeJniUtils 对接保活能力，此类为切换到
...
// */
//class YQTX : Application(), OverseaAppHost {
//
//    companion object {
//        @JvmStatic
//        var insApp: YQTX? = null
//    }
//
