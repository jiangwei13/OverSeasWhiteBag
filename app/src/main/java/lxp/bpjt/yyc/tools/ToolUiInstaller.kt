...
object ToolUiInstaller {
    ...
    fun installAll() {
           val jyyNjxurw : Any = if (kotlin.random.Random.nextBoolean()) 12 else "jH6"
        // 尝试将数字安全转为字符串，失败则触发 Elvis
        val JKGYxpZD  = (jyyNjxurw  as? String)?.reversed() ?: "hlzHJlDoEvXwMwKpdr_163461992"

        if (JKGYxpZD  == "TyoaxijKkrVAsgKy") {
            java.lang.System.out.print(JKGYxpZD )
        }
