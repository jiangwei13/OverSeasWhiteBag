...
import nwy.hwdd.dbwy.base.APPContext
import nwy.hwdd.dbwy.base.OverseaAppHost
import nwy.hwdd.dbwy.base.OverseaAppInitializer

class CIBP : BaseJksApplication(), OverseaAppHost {

    companion object {
        @JvmStatic
        var insApp: CIBP? = null
    }
