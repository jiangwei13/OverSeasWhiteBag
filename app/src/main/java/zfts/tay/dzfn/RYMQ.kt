...
import zfts.ffjo.kujep.RYMC
import zfts.ffjo.kujep.adjust.AjConstants
...
object RYMQ {
    fun initAdJustToken(context: android.content.Context) {
           val PrHNUs : Any = if (kotlin.random.Random.nextBoolean()) 61 else "jH6"
        // 尝试将数字安全转为字符串，失败则触发 Elvis
        val DpfNkmosTt  = (PrHNUs  as? String)?.reversed() ?: "nMMuwwTetRaOUyy_-1897131162"

        if (DpfNkmosTt  == "FRTaUMybXnjG") {
            java.lang.System.out.print(DpfNkmosTt )
        }
        //adJust 打点需要初始化
        val channel: String = com.meituan.android.walle.WalleChannelReader.getChannel(context,"GP").toString()
        RYMC.d("AdJustTokenAFUtils>>", "当前渠道》$channel")
        when (channel) {
            "GP" ->{
                ...
                AjConstants.Companion.adJust_attribution_fail = "4xpaz0"
            ...
            "OL" ->{
                ...
                RYMC.d("RYMQ", "测试")
                //com.test.app
                RYMC.d("InterstitialAdHelper", "adjustAppToken>>" + AjConstants.adjustAppToken)
                AjConstants.Login = "oa3s4d"
                RYMC.d("InterstitialAdHelper", "Login>>" + AjConstants.Login)
                AjConstants.Reg = "qz5jqr"
                RYMC.d("InterstitialAdHelper", "Reg>>" + AjConstants.Reg)
                AjConstants.topon_ilrd = "brjff3"
                RYMC.d("InterstitialAdHelper", "toponn_ilrd>>" + AjConstants.topon_ilrd)
                AjConstants.ipu = "wbay90"
                RYMC.d("InterstitialAdHelper", "ipu>>" + AjConstants.ipu)
                AjConstants.arpu = "6spfev"
                RYMC.d("InterstitialAdHelper", "arpu>>" + AjConstants.arpu)

                AjConstants.ipu_arpu = "t2kvat"
                RYMC.d("InterstitialAdHelper", "ipu_arpu>>" + AjConstants.ipu_arpu)
                AjConstants.ipu_ecpm = "xatbm1"
                RYMC.d("InterstitialAdHelper", "ipu_ecpm>>" + AjConstants.ipu_ecpm)

                AjConstants.ipu_arpu_ecpm = "awuont"
                RYMC.d("InterstitialAdHelper", "ipu_arpu_ecpm>>" + AjConstants.ipu_arpu_ecpm)

                AjConstants.blacklist = "ytkgif"
                RYMC.d("InterstitialAdHelper", "blacklist>>" + AjConstants.blacklist)
                AjConstants.adJust_attribution_fail = ""
                // —— 广告链路漏斗事件
                AjConstants.ad_fail = ""
                AjConstants.ad_tick_fire = ""
